...
2. 还没有角色就选：A 现成形象发图，或 B 用参考素材创建（真人照、宠物、表情包、动漫、品牌 IP 都可以）
3. 先看干净全身 + 半身，说「确认」才会进入配图。**三视图/设定板是可选项**，不要也可以
4. 知识卡片会先出 shot list，你点头再生图

**没有「试用示范角色」入口。** 仓库里的 Jinger 图是作者示范，也用来锁像素密度。请创建你自己的角色。水印用你自己的号，不要印示范角色的号。
